<?php
/**
 * Template Name: Email Unsubscribe from Salescloud
 */
get_header(); ?>
...
<p style='color: var(--gray-light); line-height: 1.6; margin-bottom: 1rem;'>Enter your email address below to be removed from our mailing list.</p>
