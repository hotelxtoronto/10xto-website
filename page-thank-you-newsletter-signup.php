<?php
/**
 * Template Name: Thank You Page Newsletter
 */
get_header(); ?>
...
<h2 style='margin-top: 2rem;'>Thank you for your submission!Our Membership Team will reach out to you shortly.</h2>
...
<div style="margin: 2rem 0; border-radius: 8px; overflow: hidden;"><img src="https://static.wixstatic.com/media/dacce5_4def4e3a08f74aa484b9e27282024aa4~mv2.jpg/v1/fill/w_391,h_261,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/ViewHXTO_withlogo.jpg" alt="" style="width: 100%; height: auto; object-fit: cover;"></div>
<div style="margin: 2rem 0; border-radius: 8px; overflow: hidden;"><img src="https://static.wixstatic.com/media/dacce5_d8b5bbc2d07142ee94ec272de87e4705~mv2.jpg/v1/fill/w_391,h_261,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/Hotel_X_Yoga_11619_0588-Edit.jpg" alt="" style="width: 100%; height: auto; object-fit: cover;"></div>
...
<div class="glass-panel" style="max-width: 600px; margin: 3rem auto; padding: 2rem; border: 2px dashed var(--yellow); text-align: center;">
    <h3 style="color: var(--yellow);">Salesforce Tracking Placeholder</h3>
    <p style="color: var(--gray-light); margin-top: 1rem;">
        Paste your Salesforce Conversion/Thank You HTML code here.<br>
        (This ensures successful form submissions are logged properly).
    </p>
    <!-- PASTE SALESFORCE HTML BELOW THIS LINE -->
    
    
    <!-- PASTE SALESFORCE HTML ABOVE THIS LINE -->
</div>
