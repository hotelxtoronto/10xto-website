...
<h1 style='margin-top: 2rem;'>SIGN UP FOR THE 10XTO NEWSLETTER</h1>
<h2 style='margin-top: 2rem;'>Stay in the know and keep up to date with 10XTO events, news, and happenings.</h2>
...
<div style="margin: 2rem 0; border-radius: 8px; overflow: hidden;"><img src="https://static.wixstatic.com/media/dacce5_acbda9e6824140d2b3687bc06694c192~mv2.jpg/v1/fill/w_147,h_83,al_c,q_80,usm_0.66_1.00_0.01,blur_2,enc_avif,quality_auto/dacce5_acbda9e6824140d2b3687bc06694c192~mv2.jpg" alt="" style="width: 100%; height: auto; object-fit: cover;"></div>
...
<div class="glass-panel" style="max-width: 600px; margin: 3rem auto; padding: 2rem; border: 2px dashed var(--yellow); text-align: center;">
    <h3 style="color: var(--yellow);">Salesforce Form Placeholder</h3>
    <p style="color: var(--gray-light); margin-top: 1rem;">
        Paste your Salesforce "Web-to-Lead" HTML code here.<br>
        (This ensures 100% accurate tracking directly into your CRM).
    </p>
